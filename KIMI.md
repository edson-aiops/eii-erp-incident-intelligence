# KIMI.md — Guia para Kimi K2.6

> Este arquivo orienta o Kimi K2.6 ao trabalhar neste repositorio.
...
KIMI.md                 Contexto para sessoes Kimi (este arquivo)
CLAUDE.md               Contexto tecnico para agentes Claude
```
...
- Crie sempre branch `feature/kimi-<descricao>` a partir da `main`
...
| 5.1 — Integracao Kimi K2.6 | Em Progresso | v3.1 |
...
**Ultima atualizacao:** 2026-05-19 (v3.1 — Integracao Kimi K2.6 ao protocolo multi-agente)
