...
def get_system_status() -> str:
    ...
    fases = [
        ...
        ("⏳", "Fase 2", "LLM + RAG — Groq + ChromaDB + Knowledge Base HCM"),
...
HCM_SYSTEMS = ["HCM", "HCM", "HCM", "HCM", "HCM"]

MODULES = {
    "HCM":        ["Payroll", "Benefits", "Recruiting", "Time & Attendance"],
    "HCM":     ["Folha de Pagamento", "Benefícios", "Recrutamento & Seleção", "Ponto & Jornada", "eSocial"],
    "HCM":        ["Payroll", "Benefits", "HR Core"],
    "HCM":      ["Payroll", "Time & Attendance"],
    "HCM": ["Workforce Management", "Time & Attendance"],
}

SAMPLE_INCIDENTS = {
    # HCM
    "HCM|Payroll":              "[ERROR] HCM: ITIN field missing for non-resident employee EMP-1234. Payroll calculation aborted for pay period 2024-11.",
    "HCM|Benefits":             "[ERROR] HCM: Benefits enrollment failed for NEW_HIRE EMP-5678. Eligibility rule 'FT_90_DAYS' not satisfied.",
    "HCM|Recruiting":           "[WARN] HCM: Job requisition REQ-9012 stuck in approval. Approver USER-456 inactive 15 days. SLA breach imminent.",
    "HCM|Time & Attendance":    "[ERROR] HCM: Time entry rejected EMP-3456: Overtime exceeds policy limit (12h). Manager approval workflow not triggered.",
    # HCM
    "HCM|Folha de Pagamento":        "[ERRO] HCM: Cálculo de rescisão bloqueado para FUNC-7890. FGTS proporcional não calculado. Competência 2024-11.",
    "HCM|eSocial":                   "[ERRO] HCM: Evento S-1200 rejeitado pelo eSocial. Código MA105 - CNPJ do estabelecimento inválido.",
    "HCM|Ponto & Jornada":           "[WARN] HCM: Banco de horas negativo para FUNC-4521. Saldo: -32h. Política de compensação não aplicada.",
    "HCM|Benefícios":                "[ERRO] HCM: Integração com operadora de plano de saúde falhou. 143 vidas pendentes de inclusão. Prazo: 3 dias.",
    "HCM|Recrutamento & Seleção":    "[WARN] HCM: Vaga VAG-2234 sem movimentação há 45 dias. SLA de contratação em risco.",
    # HCM
    "HCM|Payroll":              "[ERROR] HCM: Tax withholding calculation failed EMP-2341. Federal filing status mismatch. W-4 not updated since 2022.",
    "HCM|HR Core":              "[ERROR] HCM: Employee record sync failed. HRIS integration timeout 30s. 847 records pending.",
    "HCM|Benefits":             "[ERROR] HCM: Open enrollment auto-assignment failed. 234 employees missing elections. Deadline in 48h.",
    # HCM
    "HCM|Payroll":            "[ERROR] HCM: Direct deposit rejected for 12 employees. Routing number validation failed. Next payroll in 2 days.",
    "HCM|Time & Attendance":  "[WARN] HCM: Punch exception threshold exceeded. 23 employees missing clock-out for shift 2024-11-15.",
    # HCM
    "HCM|Workforce Management":  "[ERROR] HCM: Schedule optimization failed. Minimum rest period (11h) violation for 12 employees.",
    "HCM|Time & Attendance":     "[ERROR] HCM: Timecard approval workflow stuck. 89 timecards pending manager sign-off. Payroll processing in 4h.",
}
    ...
    with gr.Blocks(
        ...
        with gr.Tabs():
            ...
            with gr.TabItem("🚨 Incident Resolver"):
                gr.Markdown("### Submeta um incidente para análise — HCM · HCM · HCM")
...
Sistema AIOps de resolução de incidentes para **HCM e ERP corporativos**,
...
|---------|---------|
| **🔵 HCM** | Payroll, Benefits, Recruiting, Time & Attendance |
| **🟢 HCM** | Folha, Benefícios, Recrutamento, Ponto & Jornada, eSocial |
| **🟠 HCM** | Payroll, Benefits, HR Core |
| **🟠 HCM** | Payroll, Time & Attendance |
| **🟠 HCM** | Workforce Management, Time & Attendance |
