...
class EIIGeradorMassa:
    ...
    def _criar_prompt(self, caso_base, n_variacoes):
        ...
        prompt_text = "Voce e especialista em eSocial.\n\n"
        prompt_text += "Gere EXATAMENTE " + str(n_variacoes) + " casos REAIS e DIFERENTES.\n\n"
        prompt_text += "REGRA OFICIAL:\n"
        prompt_text += "- Codigo: " + codigo + "\n"
        prompt_text += "- Descricao: " + descricao + "\n"
        prompt_text += "- Categoria: " + categoria + "\n"
        prompt_text += "- Eventos: " + eventos + "\n\n"
        prompt_text += "INSTRUCOES:\n"
        prompt_text += "1. Descricao UNICA por caso\n"
        prompt_text += "2. Varie empresas, setores, valores\n"
        prompt_text += "3. Inclua XML snippet com erro\n"
        prompt_text += "4. Ground truth completo\n"
        prompt_text += "5. Mesmo codigo: " + codigo + "\n\n"
        prompt_text += "FORMATO JSON (apenas array):\n"
        prompt_text += "[\n"
        prompt_text += '  {"question": "descricao", "xml_snippet": "<tag>valor</tag>", "ground_truth": "passos", "contexto_empresa": "empresa"},\n'
        prompt_text += "  ...\n"
        prompt_text += "]\n\n"
        prompt_text += "Apenas JSON valido."
